...
python -m torch.distributed.launch \
    ...
    --use_env \
    main.py \
    --output_dir /root/autodl-tmp/dinolbh/logs0624/DINO/TUSZ/0921_800s_2stage \
    -c config/DINO/DINO_4scale_swin_tusz_multi_gpu.py \
    --dataset tusz \
    --data_dir /root/autodl-tmp/dataset_slice \
    --tusz_txt_dir /root/autodl-tmp/dataset_slice \
    --seed 42 \
    --save_log \
    --two_stage_training \
    --stage1_epochs 50 \
