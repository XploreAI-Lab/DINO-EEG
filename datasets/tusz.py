...
def build_tusz_dataloader(collate_fn, args):
    dataloaders = {}
    datasets = {}

    dataset_train = TUSZDataSet("train", args)
    dataset_validation = TUSZDataSet("dev", args)
    dataset_test = TUSZDataSet("eval", args)
